...
const UPGRADE_POOL := [
    ...
    {
        "id": "staff_beam_length",
        "title": "Посох: дальность луча",
        "description": "Лучи молнии бьют на большую дистанцию."
    },
    {
        "id": "staff_focus",
        "title": "Посох: фокус",
        "description": "Разброс лучей уменьшается, концентрируя урон."
    }
]
